...
def get_DataFrame(SQL_string, config_file):
...
def extraer_temp(df, fecha_i, fecha_f, config_file, temp='tmax'):
    '''
    ...
    df1 = get_DataFrame(SQL1, config_file) # Datos de SMN
    df2 = get_DataFrame(SQL2, config_file) # Datos de INTA
    df3 = get_DataFrame(SQL3, config_file) # Datos Interpolados
